...
餐饮店铺外卖网站\(\){
	...
	green "================================="
	sleep 2s
  sed -i '/ExecStart/s/trojan web -p 12138/trojan web/g' /etc/systemd/system/trojan-web.service
  sed -i '/ExecStart/s/trojan web/trojan web -p 12138/g' /etc/systemd/system/trojan-web.service
  ...
  green " "
	...
	green " "
	 ...
	 blue "  面板管理地址 http://$your_domain:12138 "
	green "=================================================================="
else
	green "==============================="
	  red "     Nginx未正确安装 请重试"
